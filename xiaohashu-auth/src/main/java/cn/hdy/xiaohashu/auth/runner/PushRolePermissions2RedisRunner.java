package cn.hdy.xiaohashu.auth.runner;

import cn.hdy.framework.common.util.JsonUtils;
import cn.hdy.xiaohashu.auth.constant.RedisKeyConstants;
import cn.hdy.xiaohashu.auth.domain.dataobject.PermissionDO;
import cn.hdy.xiaohashu.auth.domain.dataobject.RoleDO;
import cn.hdy.xiaohashu.auth.domain.dataobject.RolePermissionDO;
import cn.hdy.xiaohashu.auth.domain.mapper.PermissionDOMapper;
import cn.hdy.xiaohashu.auth.domain.mapper.RoleDOMapper;
import cn.hdy.xiaohashu.auth.domain.mapper.RolePermissionDOMapper;
