package cn.hdy.xiaohashu.user.biz.runner;

import cn.hdy.framework.common.util.JsonUtils;
import cn.hdy.xiaohashu.user.biz.constant.RedisKeyConstants;
import cn.hdy.xiaohashu.user.biz.domain.dataobject.PermissionDO;
import cn.hdy.xiaohashu.user.biz.domain.dataobject.RoleDO;
import cn.hdy.xiaohashu.user.biz.domain.dataobject.RolePermissionDO;
import cn.hdy.xiaohashu.user.biz.domain.mapper.PermissionDOMapper;
import cn.hdy.xiaohashu.user.biz.domain.mapper.RoleDOMapper;
import cn.hdy.xiaohashu.user.biz.domain.mapper.RolePermissionDOMapper;
